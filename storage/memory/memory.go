...
func (s *memStorage) CreateAuthRequest(_ context.Context, a storage.AuthRequest) (err error) {
	s.tx(func() {
...
func (s *memStorage) GetAuthCode(_ context.Context, id string) (c storage.AuthCode, err error) {
	s.tx(func() {
		var ok bool
